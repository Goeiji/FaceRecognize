...
#Obsrvação: Se o valor de confiança for igual a 0(zero). Significa que a possívelmente há uma imagem igual tanto no momento de teste quanto no de treinamento.